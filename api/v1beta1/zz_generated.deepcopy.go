...
func (in *ClusterOptions) DeepCopyInto(out *ClusterOptions) {
	*out = *in
	out.AddOnOptions = in.AddOnOptions
...
func (in *NodePoolNodeConfig) DeepCopyInto(out *NodePoolNodeConfig) {
	*out = *in
	in.PlacementConfigs.DeepCopyInto(&out.PlacementConfigs)
	if in.NsgNames != nil {
...
func (in *OCIManagedControlPlaneSpec) DeepCopyInto(out *OCIManagedControlPlaneSpec) {
	*out = *in
	...
	out.ClusterPodNetworkOptions = in.ClusterPodNetworkOptions
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PlacementConfigs) DeepCopyInto(out *PlacementConfigs) {
	*out = *in
	if in.FaultDomains != nil {
		in, out := &in.FaultDomains, &out.FaultDomains
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PlacementConfigs.
func (in *PlacementConfigs) DeepCopy() *PlacementConfigs {
	if in == nil {
		return nil
	}
	out := new(PlacementConfigs)
	in.DeepCopyInto(out)
	return out
}
