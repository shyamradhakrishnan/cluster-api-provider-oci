...
import (
	...
	infrastructurev1beta1 "github.com/oracle/cluster-api-provider-oci/exp/api/v1beta1"
...
func (r *OCIMachinePoolReconciler) Reconcile(ctx context.Context, req ctrl.Request) (result ctrl.Result, reterr error) {
	...
	ociMachinePool := &infrastructurev1beta1.OCIMachinePool{}
...
func (r *OCIMachinePoolReconciler) reconcileNormal(ctx context.Context, logger logr.Logger, machineScope *scope.MachineScope) (ctrl.Result, error) {
...
func (r *OCIMachinePoolReconciler) getOrCreate(ctx context.Context, scope *scope.MachineScope) (*core.Instance, error) {
	instance, err := scope.GetOrCreateMachine(ctx)
	return instance, err
}

func (r *OCIMachinePoolReconciler) reconcileDelete(ctx context.Context, machineScope *scope.MachineScope) (_ ctrl.Result, reterr error) {
...
func (r *OCIMachinePoolReconciler) deleteInstanceFromControlPlaneLB(ctx context.Context, machineScope *scope.MachineScope) error {
	if machineScope.IsControlPlane() {
